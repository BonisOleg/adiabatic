...
:root {
  /* Фірмові кольори */
  --brand-blue: #1B365D;      /* Основний синій (як промисловий стиль adiabatic) */
...
## 🏭 Промислова тематика (як adiabatic.in.ua)
...
Ця дизайн-система поєднує сучасний стиль з прикріплених зображень та промислову естетику adiabatic.in.ua, створюючи ідеальний баланс для корпоративного сайту Adiabatic з повною адаптивністю та особливою увагою до iOS Safari.
