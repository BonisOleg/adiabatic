# Style.md - Детальна дизайн-система Abiabatic
...
:root {
  /* Фірмові кольори */
  --brand-blue: #1B365D;      /* Основний синій (як промисловий стиль abiabatic) */
...
## 🏭 Промислова тематика (як abiabatic.in.ua)
...
Ця дизайн-система поєднує сучасний стиль з прикріплених зображень та промислову естетику abiabatic.in.ua, створюючи ідеальний баланс для корпоративного сайту Abiabatic з повною адаптивністю та особливою увагою до iOS Safari.
