# Generated by Django 5.1.3 on 2025-08-18 10:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='leads', to='catalog.product', verbose_name='Продукт')),
                ('source', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='leads.leadsource', verbose_name='Джерело')),
            ],
            options={
                'verbose_name': 'Заявка',
